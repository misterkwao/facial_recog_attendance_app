                        ...
                        children: [
                          ...
                          MediaQuery.removePadding(
                            ...
                            child: ListView.builder(
                              ...
                              reverse: true,
                              itemCount: value.studentNotifications.length,
                              itemBuilder: (context, index) {
                                List notification = value.studentNotifications;
                                if (notification.isEmpty) {
                                  ...
                                  return Padding(
                                    ...
                                    child: InkWell(
                                      onTap: () async {
                                        if (!(value.studentNotifications[index]
                                            ["details"]["is_read"])) {
                                          setState(() {
                                            isRead = true;
                                          });
                                        ...
                                        context
                                            ...
                                            .readNotification(
                                              context,
                                              value.studentNotifications[index]
                                                  ["_id"],
                                            );
                                        ...
                                        passedtestLink = notification[index]
                                            ["details"]["link"];
                                          ...
                                          for (var i = 0;
                                            ...
                                            if (value.upcomingClasses[i]
                                              ...
                                              selectedUpcomingClass =
                                                  value.upcomingClasses[i];

                                              print(selectedUpcomingClass);
                                            }
                                          }

                                          if ((selectedUpcomingClass[
                                                  "test_attendee_names"])
                                              .contains(value.studentProfile[
                                                  "student_name"])) {
                                            QuickAlert.show(
                                              context: context,
